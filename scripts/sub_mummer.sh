...
seqkit grep -p 89fe6f45-6dd4-4e38-87f0-a926a308bacc /oak/stanford/groups/schumer/data/Nanopore_data/xbir-BEJU-S231-9-VIII-23-M02-FGS.dorado.0.3.3.fastq.gz | seqkit fq2fa | seqkit seq -r -p -t DNA -o xbir-BEJU-S231-9-VIII-23-M02-FGS.dorado.0.3.3.fastq.gz_89fe6f45-6dd4-4e38-87f0-a926a308bacc.fa #FGS
seqkit grep -p 61093bf8-78f3-4155-a09d-a44a3df78a45 /oak/stanford/groups/schumer/data/Nanopore_data/xbir-BEJU-S231-9-VIII-23-M02-FGS.dorado.0.3.3.fastq.gz | seqkit fq2fa -o xbir-BEJU-S231-9-VIII-23-M02-FGS.dorado.0.3.3.fastq.gz_61093bf8-78f3-4155-a09d-a44a3df78a45.fa #WT /oak/stanford/groups/schumer/data/Nanopore_data/xbir-BEJU-S231-9-VIII-23-M

#nanopore read haplotypes for xbir-BEJU-S231-3-IV-23-M01-FGS
seqkit grep -f names /oak/stanford/groups/schumer/data/Nanopore_data/xbir-BEJU-S231-3-IV-23-M01-FGS.dorado.0.3.3.fastq.gz -o xbir-BEJU-S231-3-IV-23-M01-FGS.dorado.0.3.3_spanning_reads.fastq.gz
...
seqkit grep -f names1 /oak/stanford/groups/schumer/data/Nanopore_data/xbir-BEJU-S231-9-VIII-23-M01-WT.dorado.0.3.3.fastq.gz -o xbir-BEJU-S231-9-VIII-23-M01-WT.dorado.0.3.3_spanning_reads.fastq.gz
...
ln -s /scratch/groups/schumer/tris/falsegravid/pangenome/barcoding/barcoding.fa  .
